import { S as SvelteComponent, i as init, s as safe_not_equal, k as element, q as text, a as space, l as claim_element, m as children, r as claim_text, h as detach, c as claim_space, n as attr, E as null_to_empty, b as insert_hydration, O as append_hydration, u as set_data, T as noop, a0 as to_number, G as listen, _ as set_input_value, K as run_all, a1 as not_equal, e as empty, $ as prevent_default, a2 as update_keyed_each, a3 as destroy_block, f as transition_in, g as group_outros, t as transition_out, d as check_outros, Q as component_subscribe, o as onMount, a4 as onDestroy, U as svg_element, V as claim_svg_element, F as toggle_class, x as create_component, y as claim_component, z as mount_component, A as destroy_component, C as writable } from "../../chunks/index-42be36f1.js";
...
function create_each_block(key_1, ctx) {
  ...
  return {
    ...
    h() {
      ...
      ctx[15].checked;
      attr(input, "class", "svelte-pot18n");
      attr(span0, "class", "checkmark svelte-pot18n");
      attr(label, "class", "checkbox svelte-pot18n");
      attr(span1, "class", "todo-text svelte-pot18n");
      toggle_class(
        span1,
        "checked",
        /*todo*/
      ...
      attr(button0, "class", "icon-button pomodoro-button svelte-pot18n");
      ...
      attr(button1, "class", "icon-button delete-button svelte-pot18n");
      attr(div, "class", "todo svelte-pot18n");
      this.first = div;
    },
    m(target, anchor) {
...
class Todos extends SvelteComponent {
  constructor(options) {
    super();
    init(this, options, instance$1, create_fragment$1, not_equal, { className: 0 });
  }
}
